...
class DGStorage:
	def __init__(self, conf = {}):
		...
		self.DGSTORAGE_VERSION = '2.4.1'
		self.DGSTORAGE_CHARSET = 'utf8'
		self.DGSTORAGE_SINGLECOLLECTIONLIMIT = 4096
		self.DGSTORAGE_SEARCHRANGE = 16
		self.DGSTORAGE_SEARCHINDEXLIMIT = 64
		self.DGSTORAGE_SEARCHCACHELIMIT = 64
		self.DGSTORAGE_PROPCACHELIMIT = 64
